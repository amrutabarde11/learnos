...
export default function Sidebar({ page, setPage, darkMode, setDarkMode, user, onReset }) {
  return (
    <nav className="sidebar">
      ...
      {user && (
        <div style={{ padding: '10px 14px', marginBottom: 20, background: 'rgba(247,243,236,0.08)', borderRadius: 10 }}>
          <div style={{ fontSize: 11, color: 'rgba(247,243,236,0.4)', marginBottom: 2 }}>Signed in as</div>
      ...
      <div className="sidebar-bottom">
        ...
        {onReset && (
          <button
            ...
            onClick={() => { if (window.confirm('Reset profile? This clears all local data.')) onReset(); }}
            style={{ color: 'rgba(201,133,122,0.7)' }}
          >
            <span>↺</span>
            Reset Profile
          </button>
